...
/**
 * Configuration Feign qui intercepte les requêtes pour ajouter un header d'authentification Basic.
 * Les identifiants (username et password) sont injectés depuis les propriétés de configuration.
 */
